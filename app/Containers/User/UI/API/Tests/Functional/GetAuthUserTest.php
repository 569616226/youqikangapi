...
class GetAuthUserTest extends TestCase
{
    ...
    protected $endpoint = 'get@v1/user/profile?include=roles,companies';
    ...
    public function testGetAuthUserTest_()
    {
        ...
        $this->assertEquals($admin->is_client_admin, $responseContent->data->is_client_admin);
        ...
        $this->assertNotNull($responseContent->data->companies);
    }
