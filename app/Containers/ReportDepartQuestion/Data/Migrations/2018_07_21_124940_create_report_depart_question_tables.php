...
class CreateReportDepartQuestionTables extends Migration
{
    ...
    public function up()
    {
        Schema::create('report_depart_questions', function (Blueprint $table) {
            ...
            $table->longText('question_details')->nullable()->comment('进一步提问 array');

            $table->integer('report_depart_id')->unsigned();
            $table->foreign('report_depart_id')->references('id')->on('report_departs')->onDelete('cascade');
    ...
    {
        Schema::drop('report_depart_questions');
    }
}
